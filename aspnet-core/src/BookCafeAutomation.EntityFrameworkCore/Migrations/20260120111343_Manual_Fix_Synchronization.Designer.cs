...
namespace BookCafeAutomation.Migrations
{
    ...
    [Migration("20260120111343_Manual_Fix_Synchronization")]
    partial class Manual_Fix_Synchronization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookCafeAutomation.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookCafeAutomation.BookActions.BookAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppBookActions", (string)null);
                });

            modelBuilder.Entity("BookCafeAutomation.BookNotes.BookNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppBookNotes", (string)null);
                });

            modelBuilder.Entity("BookCafeAutomation.BookReservations.BookReservation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("ReservationExpirationTime")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("AppBookReservations", (string)null);
                });

            modelBuilder.Entity("BookCafeAutomation.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookCafeAutomation.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookCafeAutomation.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookCafeAutomation.BookActions.BookAction", b =>
                {
                    ...
                    b.HasOne("BookCafeAutomation.Customers.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("BookCafeAutomation.Books.Book", b =>
                {
                    b.HasOne("BookCafeAutomation.Authors.Author", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookCafeAutomation.Categories.Category", "Category")
                        .WithMany()
