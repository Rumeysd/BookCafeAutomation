    ...
    public partial class Initial_Postgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBookActions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppBookActions_AppBooks_BookId",
                        column: x => x.BookId,
                        principalTable: "AppBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppBookActions_AppCustomers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBookImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppBookImages_AppBooks_BookId",
                        column: x => x.BookId,
                        principalTable: "AppBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppBookImages_AppBooks_BookId1",
                        column: x => x.BookId1,
                        principalTable: "AppBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBookNotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppBookNotes_AppBooks_BookId",
                        column: x => x.BookId,
                        principalTable: "AppBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppBookNotes_AppCustomers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AppCustomers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<Guid>(type: "uuid", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ReservationExpirationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBookReservations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppBookReservations_AppBooks_BookId",
                        column: x => x.BookId,
                        principalTable: "AppBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppBookReservations_AppCustomers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AppCustomers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppBookActions_BookId",
                table: "AppBookActions",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookActions_CustomerId",
                table: "AppBookActions",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookImages_BookId",
                table: "AppBookImages",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookImages_BookId1",
                table: "AppBookImages",
                column: "BookId1");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookNotes_BookId",
                table: "AppBookNotes",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookNotes_CustomerId",
                table: "AppBookNotes",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookReservations_BookId",
                table: "AppBookReservations",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_AppBookReservations_CustomerId",
                table: "AppBookReservations",
                column: "CustomerId");
